...
var ratingSerive = __importStar(require("../../services"));
var logger_1 = require("../../util/logger");
function getAverageRating(req, res, next) {
    ratingSerive.getAverageRating(__assign(__assign({}, req.query), req.cookies))
        .then(function (score) {
...
//# sourceMappingURL=getAverageRating.controller.js.map